...
<div class="container info-container">
    ...
    <div class="row ">
        <div class="col-sm-12 item">
            ...
            <br>
            <p>
                La compra mínima son {{ $settings->reseller_min }} prendas en el surtido que quieras<br>
                ...
                - Andresmar<br>
                - MD Cargas<br><br>
                <b>El envío siempre es a cuenta del comprador</b>
                <br>
                <br>
                ...
                Las fotos de la marca solo pueden ser utilizadas tal como están en nuestras redes. No pueden agregarse textos.
                <br><br><br>
            </p>
            <hr><br>
